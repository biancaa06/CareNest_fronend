...
function SicknessItem({ sickness, deleteSickness, updateSickness }) {
    return (
        <li className="w-full">
            <div data-cy='sicknessItem' className="flex items-center p-3 w-full text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow-lg dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
